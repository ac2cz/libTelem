...
//	FoxSpacecraft fox;
	...
	int topBorder = (int)(graphAxisFontSize*2); //Config.graphAxisFontSize; // The distance from the top of the drawing surface to the graph.  The title goes in this space
	int bottomBorder = (int)(graphAxisFontSize*2.5); // The distance from the bottom of the drawing surface to the graph
	int sideBorder = (int)(graphAxisFontSize *5); // left side border.  The position that the axis is drawn and the graph starts
	int sideLabelOffset = (int)(graphAxisFontSize *0.5); // offset before we draw a label on the vertical axis
	static int labelWidth = (int)(6 * graphAxisFontSize);  // 40 was a bit too tight for 6 digit uptime
	static int labelHeight = (int)(graphAxisFontSize * 1.4);
